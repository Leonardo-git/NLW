...
const Detail = () => {
    ...
    function handleWhatsapp(){
        Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho interece sobre coleta de residuos`)
    }
    ...
    return (
        ...
        <SafeAreaView style={{flex: 1, paddingBottom: 2, paddingTop: 20}}>
